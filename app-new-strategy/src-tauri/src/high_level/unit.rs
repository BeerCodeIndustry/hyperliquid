...
pub async fn get_unit_user_states(
    ...
    let (info_client_1, info_client_2, info_client_3, info_client_4) =
        tokio::join!(get_info_client(&account_1), get_info_client(&account_2), get_info_client(&account_3), get_info_client(&account_4));
