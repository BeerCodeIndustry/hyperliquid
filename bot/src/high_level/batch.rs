...
async fn init_account(account: Account, asset: &str, leverage: u32) -> Handlers {
    let Account {
        public_address,
        private_api_key,
        proxy,
